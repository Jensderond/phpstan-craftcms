...
namespace Jensderond\PhpstanCraftcms;
...
final class ServiceMap
{
    ...
    public function getServiceClassFromNode(Node $node): ?string
    {
        ...
        // First check if it's registered in services
        if (isset($this->services[$service])) {
            return $this->services[$service];
        }

        // If it's a class name and the class exists, return it directly
